    ...
    <div className="min-h-screen bg-gradient-dark flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-subtle">
          ...
          <p className="text-muted-foreground text-center mb-8">Connectez-vous pour commencer</p>
          <Button onClick={handleGoogleLogin} variant="premium" size="lg" className="w-full">
