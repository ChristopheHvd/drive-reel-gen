...
export const PLAN_CONFIGS: Record<"free" | "starter" | "pro" | "business", PlanConfig> = {
  free: {
    ...
    price: 0,
    videoLimit: 6,
    features: ["6 vidéos", "Format 9:16 et 16:9", "Support communautaire"],
    stripePriceId: "",
  },
  starter: {
    name: "Starter",
    price: 29,
    videoLimit: 20,
    features: ["20 vidéos par mois*", "Brand Kit", "Upload illimité", "Tous les formats : 8sec, 16sec, 24sec"],
  ...
  pro: {
    ...
    features: ["Vidéos illimitées*", "Multi-utilisateur", "Support email"],
  ...
  business: {
    ...
    price: 199,
    videoLimit: "unlimited",
    features: ["API access", "Formation équipe", "Support dédié"],
